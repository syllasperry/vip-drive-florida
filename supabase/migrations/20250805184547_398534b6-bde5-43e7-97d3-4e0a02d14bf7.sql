...
CREATE INDEX idx_ride_status_timestamp ON public.ride_status(timestamp);
CREATE INDEX idx_ride_status_actor_timestamp ON public.ride_status(ride_id, actor_role, timestamp DESC);
...
BEGIN
    ...
    ORDER BY rs.actor_role, rs.timestamp DESC;
END;
$$;
