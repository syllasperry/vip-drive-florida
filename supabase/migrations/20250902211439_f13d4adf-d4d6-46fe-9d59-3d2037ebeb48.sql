-- Fix complete_payment_transaction to use correct enum value for booking_sync_status
...
BEGIN
  ...
  SET 
    payment_status = 'paid',
    status = 'payment_confirmed',  -- Use 'payment_confirmed' which is valid in the booking_sync_status enum
